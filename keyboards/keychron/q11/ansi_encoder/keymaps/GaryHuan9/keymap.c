...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [DEFAULT] = LAYOUT_91_ansi(
        KC_MPLY,  KC_ESC,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,     KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,    KC_F12,   KC_PSCR,  KC_DEL,   KC_ENT,
        ...
        _______,  KC_LCTL,  KC_LGUI,  KC_LALT,  MO(L_O),            KC_SPC,                        KC_SPC,             MO(L_O),  KC_RALT,   KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),

    [OVERLAY] = LAYOUT_91_ansi(
        KC_MUTE,  RM_TOGG,  KC_BRID,  KC_BRIU,  KC_MCTL,  KC_LPAD,  RM_VALD,   RM_VALU,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,   KC_VOLU,  _______,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,   _______,  _______,  _______,  _______,  _______,  _______,   _______,  _______,            _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,   KC_9,     KC_0,     KC_MINS,  KC_EQL,   _______,  _______,   _______,  _______,            _______,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [DEFAULT] = { ENCODER_CCW_CW(KC_MPRV, KC_MNXT), ENCODER_CCW_CW(C(KC_Z), C(S(KC_Z))) },
    [OVERLAY] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(MS_WHLR, MS_WHLL) },
